...
제품 배경/문제정의/요구사항은 [`docs/prd.md`](./docs/prd.md) (PRD v1.0, 2026-09-12 기준)가 정본이다. 화면별 API 설계 참고는 [`docs/wireframes.md`](./docs/wireframes.md) (Figma 와이어프레임 매핑).
...
- [x] S01·S02 와이어프레임 → API 설계 참고 정리 (`docs/wireframes.md`, 나머지 화면은 Figma 공유되는 대로 추가)
